...
System architecture will follow the monolithic architecture pattern as shown in the following high-level diagram:
...
We'll deploy the server to heroku or similar free hosting platform. A domain will be  
