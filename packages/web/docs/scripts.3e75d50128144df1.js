!(function (U, fe) {
  'object' == typeof exports && typeof module < 'u'
    ...
    : 'function' == typeof define && define.amd
      ? define(fe)
      : ((U = typeof globalThis < 'u' ? globalThis : U || self).bootstrap = fe());
})(this, function () {
  'use strict';
  const U = new Map(),
    fe = {
      set(i, e, t) {
        U.has(i) || U.set(i, new Map());
        const n = U.get(i);
        n.has(e) || 0 === n.size
          ? n.set(e, t)
          : console.error(
      ...
      get: (i, e) => (U.has(i) && U.get(i).get(e)) || null,
      remove(i, e) {
        if (!U.has(i)) return;
        const t = U.get(i);
        t.delete(e), 0 === t.size && U.delete(i);
      },
    },
    Et = 'transitionend',
    ci = i => (
    ...
    ie = i =>
      !(!i || 'object' != typeof i) && (void 0 !== i.jquery && (i = i[0]), void 0 !== i.nodeType),
    ae = i =>
      ie(i)
        ? i.jquery
          ? i[0]
        ...
        : 'string' == typeof i && i.length > 0
          ...
          : null,
    Ce = i => {
      if (!ie(i) || 0 === i.getClientRects().length) return !1;
      const e = 'visible' === getComputedStyle(i).getPropertyValue('visibility'),
        t = i.closest('details:not([open])');
      if (!t) return e;
      if (t !== i) {
        const n = i.closest('summary');
        if ((n && n.parentNode !== t) || null === n) return !1;
      }
      return e;
    },
    le = i =>
      ...
      (void 0 !== i.disabled
        ? i.disabled
        : i.hasAttribute('disabled') && 'false' !== i.getAttribute('disabled')),
    di = i => {
      if (!document.documentElement.attachShadow) return null;
      if ('function' == typeof i.getRootNode) {
        const e = i.getRootNode();
        return e instanceof ShadowRoot ? e : null;
      }
      return i instanceof ShadowRoot ? i : i.parentNode ? di(i.parentNode) : null;
    },
    et = () => {},
    ui = () =>
    ...
    j = (i, e = [], t = i) => ('function' == typeof i ? i(...e) : t),
    fi = (i, e, t = !0) => {
    ...
    Tt = (i, e, t, n) => {
      ...
      return -1 === o
        ? !t && n
          ? i[s - 1]
          : i[0]
        : ((o += t ? 1 : -1), n && (o = (o + s) % s), i[Math.max(0, Math.min(o, s - 1))]);
    },
    is = /[^.]*(?=\..*)\.|.*/,
    ns = /\..*/,
    ss = /::\d+$/,
  ...
  function yi(i, e, t, n, s) {
    ...
    e in mi &&
      ...
      (r = function (m) {
        if (
          !m.relatedTarget ||
          (m.relatedTarget !== m.delegateTarget && !m.delegateTarget.contains(m.relatedTarget))
        )
  ...
  const l = {
    ...
    off(i, e, t, n) {
      ...
      const [s, o, r] = vi(e, t, n),
        ...
        u = e.startsWith('.');
      if (void 0 === o) {
        if (u) for (const h of Object.keys(c)) rs(i, c, h, e.slice(1));
        for (const [h, b] of Object.entries(d)) {
          const p = h.replace(ss, '');
          (a && !e.includes(p)) || Ot(i, c, r, b.callable, b.delegationSelector);
        }
      } else {
    ...
    trigger(i, e, t) {
      if ('string' != typeof e || !i) return null;
      const n = ui();
      let s = null,
        o = !0,
        r = !0,
  ...
  const ne = {
    ...
    getDataAttributes(i) {
      if (!i) return {};
      const e = {},
        t = Object.keys(i.dataset).filter(n => n.startsWith('bs') && !n.startsWith('bsConfig'));
      for (const n of t) {
        let s = n.replace(/^bs/, '');
        (s = s.charAt(0).toLowerCase() + s.slice(1, s.length)), (e[s] = Ei(i.dataset[n]));
      }
      return e;
    },
  ...
  class Y extends Re {
    ...
    static getInstance(e) {
      return fe.get(ae(e), this.DATA_KEY);
    }
  ...
  const Lt = i => {
    ...
    f = {
      ...
      findOne: (i, e = document.documentElement) => Element.prototype.querySelector.call(e, i),
      children: (i, e) => [].concat(...i.children).filter(t => t.matches(e)),
      parents(i, e) {
        const t = [];
      ...
      focusableChildren(i) {
        const e = [
          ...
          .join(',');
        return this.find(e, i).filter(t => !le(t) && Ce(t));
      },
    ...
    tt = (i, e = 'hide') => {
      const n = i.NAME;
      l.on(document, `click.dismiss${i.EVENT_KEY}`, `[data-bs-dismiss="${n}"]`, function (s) {
        if ((['A', 'AREA'].includes(this.tagName) && s.preventDefault(), le(this))) return;
  ...
  class qe extends Y {
    ...
    close() {
      if (l.trigger(this._element, as).defaultPrevented) return;
      this._element.classList.remove('show');
      const e = this._element.classList.contains('fade');
      this._queueCallback(() => this._destroyElement(), this._element, e);
    }
    _destroyElement() {
      this._element.remove(), l.trigger(this._element, ls), this.dispose();
    }
  ...
  const Oe = '.bs.swipe',
    ...
    us = `pointerdown${Oe}`,
    fs = `pointerup${Oe}`,
    ps = { endCallback: null, leftCallback: null, rightCallback: null },
    ms = {
  ...
  class it extends Re {
    ...
    _initEvents() {
      this._supportPointerEvents
        ? (l.on(this._element, us, e => this._start(e)),
          l.on(this._element, fs, e => this._end(e)),
          this._element.classList.add('pointer-event'))
        : (l.on(this._element, cs, e => this._start(e)),
          l.on(this._element, hs, e => this._move(e)),
          l.on(this._element, ds, e => this._end(e)));
    }
  ...
  const ce = '.bs.carousel',
    ...
    ki = '.carousel-item',
    As = xi + ki,
    Ts = { ArrowLeft: nt, ArrowRight: ke },
    Cs = { interval: 5e3, keyboard: !0, pause: 'hover', ride: !1, touch: !0, wrap: !0 },
    Os = {
  ...
  class Le extends Y {
    ...
    nextWhenVisible() {
      !document.hidden && Ce(this._element) && this.next();
    }
    prev() {
      this._slide(xe);
    }
    ...
    _maybeEnableCycle() {
      this._config.ride &&
        (this._isSliding ? l.one(this._element, St, () => this.cycle()) : this.cycle());
    }
    to(e) {
      const t = this._getItems();
      if (e > t.length - 1 || e < 0) return;
      if (this._isSliding) return void l.one(this._element, St, () => this.to(e));
      const n = this._getItemIndex(this._getActive());
      n !== e && this._slide(e > n ? Ke : xe, t[e]);
    }
    dispose() {
    ...
    _addEventListeners() {
      this._config.keyboard && l.on(this._element, _s, e => this._keydown(e)),
        'hover' === this._config.pause &&
          (l.on(this._element, bs, () => this.pause()),
          l.on(this._element, vs, () => this._maybeEnableCycle())),
        this._config.touch && it.isSupported() && this._addTouchEventListeners();
    }
    _addTouchEventListeners() {
      for (const t of f.find('.carousel-item img', this._element))
        l.on(t, ys, n => n.preventDefault());
      this._swipeHelper = new it(this._element, {
    ...
    _slide(e, t = null) {
      ...
      if (a(gs).defaultPrevented || !n || !o) return;
    ...
    _getActive() {
      return f.findOne(As, this._element);
    }
    _getItems() {
    ...
    _directionToOrder(e) {
      return B() ? (e === ke ? xe : Ke) : e === ke ? Ke : xe;
    }
    _orderToDirection(e) {
      return B() ? (e === xe ? ke : nt) : e === xe ? nt : ke;
    }
    static jQueryInterface(e) {
      return this.each(function () {
  ...
  const Xe = '.bs.collapse',
    ...
    Ns = { parent: '(null|element)', toggle: 'boolean' };
  class De extends Y {
    constructor(e, t) {
      ...
      if (
        (this._config.parent &&
          (e = this._getFirstLevelChildren('.collapse.show, .collapse.collapsing')
            ...
            .map(s => De.getOrCreateInstance(s, { toggle: !1 }))),
        (e.length && e[0]._isTransitioning) || l.trigger(this._element, xs).defaultPrevented)
      )
        return;
      ...
      this._queueCallback(
        () => {
          (this._isTransitioning = !1),
            ...
            this._element.classList.add(Se, Dt),
    ...
    hide() {
      if (
        ...
        !this._isShown() ||
        l.trigger(this._element, Ls).defaultPrevented
      )
        return;
      const e = this._getDimension();
      (this._element.style[e] = `${this._element.getBoundingClientRect()[e]}px`),
        this._element.classList.add(ot),
        this._element.classList.remove(Se, Dt);
    ...
    _getFirstLevelChildren(e) {
      const t = f.find($s, this._config.parent);
  ...
  l.on(document, Ds, $t, function (i) {
    ('A' === i.target.tagName || (i.delegateTarget && 'A' === i.delegateTarget.tagName)) &&
      i.preventDefault();
    for (const e of f.getMultipleElementsFromSelector(this))
      De.getOrCreateInstance(e, { toggle: !1 }).toggle();
  }),
    z(De);
  var $ = 'top',
    M = 'bottom',
    ...
    Ne = 'popper',
    Si = 'reference',
    Nt = $e.reduce(function (i, e) {
      return i.concat([e + '-' + pe, e + '-' + Ie]);
    }, []),
    Pt = [].concat($e, [rt]).reduce(function (i, e) {
      return i.concat([e, e + '-' + pe, e + '-' + Ie]);
    }, []),
    Di = 'beforeRead',
    Ii = 'afterRead',
    Ni = 'beforeMain',
    ...
    Mi = 'beforeWrite',
    Hi = 'afterWrite',
    Wi = [Di, 'read', Ii, Ni, 'main', ji, Mi, 'write', Hi];
  function Z(i) {
    return i ? (i.nodeName || '').toLowerCase() : null;
  }
  function H(i) {
    if (null == i) return window;
    if ('[object Window]' !== i.toString()) {
  ...
  function jt(i) {
    return typeof ShadowRoot < 'u' && (i instanceof H(i).ShadowRoot || i instanceof ShadowRoot);
  }
  const Mt = {
    name: 'applyStyles',
    enabled: !0,
      ...
      Object.keys(e.elements).forEach(function (t) {
        ...
        R(o) &&
          ...
          Object.keys(s).forEach(function (r) {
            var a = s[r];
            !1 === a ? o.removeAttribute(r) : o.setAttribute(r, !0 === a ? '' : a);
          }));
      });
    },
    effect: function (i) {
      ...
      return (
        ...
        function () {
          Object.keys(e.elements).forEach(function (n) {
            var s = e.elements[n],
              o = e.attributes[n] || {},
              r = Object.keys(e.styles.hasOwnProperty(n) ? e.styles[n] : t[n]).reduce(function (
                a,
                c
              ) {
                return (a[c] = ''), a;
  ...
  function Ft() {
    ...
    return null != i && i.brands && Array.isArray(i.brands)
      ? i.brands
          .map(function (e) {
  ...
  function je(i, e, t) {
    ...
    e &&
      R(i) &&
      ((s = (i.offsetWidth > 0 && Pe(n.width) / i.offsetWidth) || 1),
      (o = (i.offsetHeight > 0 && Pe(n.height) / i.offsetHeight) || 1));
    var r = (me(i) ? H(i) : window).visualViewport,
      a = !Bi() && t,
      c = (n.left + (a && r ? r.offsetLeft : 0)) / s,
      d = (n.top + (a && r ? r.offsetTop : 0)) / o,
      u = n.width / s,
      h = n.height / o;
    return { width: u, height: h, top: d, right: c + u, bottom: d + h, left: c, x: c, y: d };
  }
  function Ht(i) {
    var e = je(i),
      t = i.offsetWidth,
  ...
  function he(i) {
    return ((me(i) ? i.ownerDocument : i.document) || window.document).documentElement;
  }
  function lt(i) {
    return 'html' === Z(i) ? i : i.assignedSlot || i.parentNode || (jt(i) ? i.host : null) || he(i);
  }
  function Ri(i) {
    return R(i) && 'fixed' !== se(i).position ? i.offsetParent : null;
  }
  function Ue(i) {
    for (var e = H(i), t = Ri(i); t && Ps(t) && 'static' === se(t).position; ) t = Ri(t);
    return t && ('html' === Z(t) || ('body' === Z(t) && 'static' === se(t).position))
      ? e
      : t ||
          (function (n) {
            var s = /firefox/i.test(Ft());
            if (/Trident/i.test(Ft()) && R(n) && 'fixed' === se(n).position) return null;
            var o = lt(n);
            for (jt(o) && (o = o.host); R(o) && ['html', 'body'].indexOf(Z(o)) < 0; ) {
              var r = se(o);
              if (
                'none' !== r.transform ||
                'none' !== r.perspective ||
                ...
                (s && 'filter' === r.willChange) ||
                (s && r.filter && 'none' !== r.filter)
              )
                return o;
              o = o.parentNode;
            }
    ...
    fn: function (i) {
      ...
      if (o && r) {
        var u =
          ...
          b = 'y' === c ? $ : I,
          p = 'y' === c ? M : F,
          g = t.rects.reference[d] + t.rects.reference[c] - r[c] - t.rects.popper[d],
          m = r[c] - t.rects.reference[c],
          _ = Ue(o),
          C = _ ? ('y' === c ? _.clientHeight || 0 : _.clientWidth || 0) : 0,
          v = C / 2 - h[d] / 2 + (g / 2 - m / 2),
          w = Ye(u[b], v, C - h[d] - u[p]);
        t.modifiersData[n] = (((e = {})[c] = w), (e.centerOffset = w - v), e);
      }
    },
    effect: function (i) {
      var e = i.state,
  ...
  function Xi(i) {
    var e,
      ...
      g = r.y,
      m = void 0 === g ? 0 : g,
      _ = 'function' == typeof u ? u({ x: p, y: m }) : { x: p, y: m };
    (p = _.x), (m = _.y);
    ...
    if (d) {
      var w = Ue(t),
        ...
        O = 'clientWidth';
      w === H(t) &&
        'static' !== se((w = he(t))).position &&
        'absolute' === a &&
        ((A = 'scrollHeight'), (O = 'scrollWidth')),
        (s === $ || ((s === I || s === F) && o === Ie)) &&
          ((E = M),
          (m -= (h && w === v && v.visualViewport ? v.visualViewport.height : w[A]) - n.height),
          (m *= c ? 1 : -1)),
        (s !== I && ((s !== $ && s !== M) || o !== Ie)) ||
          ((y = F),
          (p -= (h && w === v && v.visualViewport ? v.visualViewport.width : w[O]) - n.width),
          (p *= c ? 1 : -1));
    }
    var T,
      G,
      ...
      K,
      L,
      S = Object.assign({ position: a }, d && js),
      W =
        !0 === u
          ? ((G = { x: p, y: m }),
            (N = H(t)),
            (K = G.y),
            { x: Pe(G.x * (L = N.devicePixelRatio || 1)) / L || 0, y: Pe(K * L) / L || 0 })
          : { x: p, y: m };
    return (
      (p = W.x),
      (m = W.y),
      Object.assign(
        ...
        c
          ? (((T = {})[E] = k ? '0' : ''),
            ...
            T)
          : (((e = {})[E] = k ? m + 'px' : ''), (e[y] = C ? p + 'px' : ''), (e.transform = ''), e)
      )
    );
  }
  const Bt = {
  ...
  function qt(i) {
    return je(he(i)).left + Rt(i).scrollLeft;
  }
  function Vt(i) {
    var e = se(i);
  ...
  function Yi(i) {
    return ['html', 'body', '#document'].indexOf(Z(i)) >= 0
  ...
  function Qe(i, e) {
    ...
    void 0 === e && (e = []);
    var n = Yi(i),
      s = n === (null == (t = i.ownerDocument) ? void 0 : t.body),
      o = H(n),
      ...
      ? Kt(
          (function (n, s) {
            ...
            if (a) {
              ...
              var b = Bi();
              (b || (!b && 'fixed' === s)) && ((u = a.offsetLeft), (h = a.offsetTop));
            }
            return { width: c, height: d, x: u + qt(n), y: h };
          })(i, t)
        )
      : me(e)
        ? (((o = je((n = e), !1, 'fixed' === t)).top = o.top + n.clientTop),
        ...
        : Kt(
            (function (n) {
              var s,
                o = he(n),
                r = Rt(n),
                a = null == (s = n.ownerDocument) ? void 0 : s.body,
                c = ge(o.scrollWidth, o.clientWidth, a ? a.scrollWidth : 0, a ? a.clientWidth : 0),
                d = ge(
                  o.scrollHeight,
                  o.clientHeight,
                  a ? a.scrollHeight : 0,
                ...
                h = -r.scrollTop;
              return (
                'rtl' === se(a || o).direction &&
                  (u += ge(o.clientWidth, a ? a.clientWidth : 0) - c),
  ...
  function Fe(i, e) {
    ...
    var N,
      ...
      D,
      n = e.placement,
      s = void 0 === n ? i.placement : n,
      o = e.strategy,
      r = void 0 === o ? i.strategy : o,
      a = e.boundary,
      c = void 0 === a ? Li : a,
      d = e.rootBoundary,
      u = void 0 === d ? It : d,
      ...
      m = e.padding,
      _ = void 0 === m ? 0 : m,
      C = qi('number' != typeof _ ? _ : Vi(_, $e)),
      y = i.rects.popper,
      E = i.elements[g ? (b === Ne ? Si : Ne) : b],
      v =
        ((N = me(E) ? E : E.contextElement || he(i.elements.popper)),
        (K = u),
        (L = r),
        (ee =
          'clippingParents' === (V = c)
            ? ((P = Qe(lt((x = N)))),
              me((X = ['absolute', 'fixed'].indexOf(se(x).position) >= 0 && R(x) ? Ue(x) : x))
                ? P.filter(function (ue) {
                    return me(ue) && zi(ue, X) && 'body' !== Z(ue);
                  })
                : [])
            : [].concat(V)),
        (D = (te = [].concat(ee, [K])).reduce(
          function (x, P) {
            var X = Qi(N, P, L);
            return (
              (x.top = ge(X.top, x.top)),
              (x.right = at(X.right, x.right)),
              (x.bottom = at(X.bottom, x.bottom)),
              (x.left = ge(X.left, x.left)),
              x
            );
          },
          Qi(N, te[0], L)
        ...
        (D.y = D.top),
        D),
      w = je(i.elements.reference),
      A = Gi({ reference: w, element: y, strategy: 'absolute', placement: s }),
      ...
      if (!e.modifiersData[n]._skip) {
        for (
                ...
                J(P) === rt
                  ? (function Hs(i, e) {
                      ...
                      var p = b.reduce(function (g, m) {
                        return (
                          (g[m] = Fe(i, { placement: m, boundary: s, rootBoundary: o, padding: r })[
                            J(m)
                          ]),
                          g
                        );
          ...
          var S = y[T],
            ...
            N = [$, M].indexOf(W) >= 0,
            V = N ? 'width' : 'height',
            K = Fe(e, { placement: S, boundary: u, rootBoundary: h, altBoundary: b, padding: d }),
            L = N ? (G ? F : I) : G ? M : $;
          E[V] > v[V] && (L = ht(L));
          var ee = ht(L),
            te = [];
  ...
  const tn = {
      ...
      fn: function (i) {
        var e = i.state,
          ...
          r = Fe(e, { elementContext: 'reference' }),
    ...
    nn = {
      ...
      fn: function (i) {
        var e = i.state,
          ...
          r = Pt.reduce(function (u, h) {
            return (
              (u[h] =
                ...
                (k =
                  (k = (C =
                    'function' == typeof g ? g(Object.assign({}, p, { placement: b })) : g)[0]) ||
                  0),
                (y = ((y = C[1]) || 0) * _),
          ...
          d = a.y;
        null != e.modifiersData.popperOffsets &&
          ((e.modifiersData.popperOffsets.x += a.x), (e.modifiersData.popperOffsets.y += d)),
          (e.modifiersData[n] = r);
      },
    },
    Xt = {
        ...
        if (w) {
          if (o) {
            var N,
              ...
              Vn = vt[K],
              yt = Ye(0, A[L], ue[L]),
              mr = y ? A[L] / 2 - D - yt - qn - S.mainAxis : x - yt - qn - S.mainAxis,
              gr = y ? -A[L] / 2 + D + yt + Vn + S.mainAxis : P + yt + Vn + S.mainAxis,
              ri = e.elements.arrow && Ue(e.elements.arrow),
              _r = ri ? ('y' === E ? ri.clientTop || 0 : ri.clientLeft || 0) : 0,
              Kn = null != (N = W?.[E]) ? N : 0,
              br = ee + gr - Kn,
              Xn = Ye(p ? at(te, ee + mr - Kn - _r) : te, ee, p ? ge(Be, br) : Be);
            (w[E] = Xn), (G[E] = Xn - ee);
          }
          if (a) {
            var Un,
              ...
              ai = -1 !== [$, I].indexOf(C),
              Gn = null != (Un = W?.[v]) ? Un : 0,
              Zn = ai ? Yn : Te - A[wt] - O[wt] - Gn + S.altAxis,
              Jn = ai ? Te + A[wt] + O[wt] - Gn - S.altAxis : Qn,
              es =
                p && ai
                  ? (ts = Ye(Zn, Te, (li = Jn))) > li
                    ? li
                    : ts
                  : Ye(p ? Zn : Yn, Te, p ? Jn : Qn);
            (w[v] = es), (G[v] = es - Te);
          }
          e.modifiersData[n] = G;
        }
  ...
  function Ws(i, e, t) {
    ...
    var n,
      ...
      r =
        R(e) &&
        ((b = (h = e).getBoundingClientRect()),
        (p = Pe(b.width) / h.offsetWidth || 1),
        (g = Pe(b.height) / h.offsetHeight || 1),
        1 !== p || 1 !== g),
      a = he(e),
      c = je(i, r, t),
        ...
        (('body' !== Z(e) || Vt(a)) &&
          (d =
            (n = e) !== H(n) && R(n)
              ...
              : Rt(n)),
        R(e) ? (((u = je(e, !0)).x += e.clientLeft), (u.y += e.clientTop)) : a && (u.x = qt(a))),
      {
      ...
      var d,
        ...
        g = {
          ...
          setOptions: function (_) {
            var C = 'function' == typeof _ ? _(h.options) : _;
            m(),
              (h.options = Object.assign({}, o, h.options, C)),
              (h.scrollParents = {
                reference: me(r) ? Qe(r) : r.contextElement ? Qe(r.contextElement) : [],
                popper: Qe(a),
              });
            var k,
              y,
              ...
              E =
                ...
                (v = Object.keys(y).map(function (v) {
                  return y[v];
                })),
                (w = Bs(v)),
                Wi.reduce(function (A, O) {
                  return A.concat(
                    w.filter(function (T) {
                      return T.phase === O;
                    })
          ...
          forceUpdate: function () {
            if (!p) {
              ...
              if (rn(C, k)) {
                (h.rects = {
                  reference: Ws(C, Ue(k), 'fixed' === h.options.strategy),
                  popper: Ht(k),
                }),
                  (h.reset = !1),
  ...
  var zs = dt(),
    Rs = dt({ defaultModifiers: [zt, Xt, Bt, Mt] }),
  ...
  const an = Object.freeze(
    ...
    Qs = `${be}.${He}`,
    ut = '.dropdown-menu',
    Gs = B() ? 'top-end' : 'top-start',
    Zs = B() ? 'top-start' : 'top-end',
    Js = B() ? 'bottom-end' : 'bottom-start',
    eo = B() ? 'bottom-start' : 'bottom-end',
    to = B() ? 'left-start' : 'right-start',
    io = B() ? 'right-start' : 'left-start',
    no = {
      autoClose: !0,
  ...
  class Q extends Y {
    ...
    show() {
      ...
      if (!l.trigger(this._element, Xs, e).defaultPrevented) {
        if (
          (this._createPopper(),
          'ontouchstart' in document.documentElement && !this._parent.closest('.navbar-nav'))
        )
          for (const t of [].concat(...document.body.children)) l.on(t, 'mouseover', et);
        this._element.focus(),
          this._element.setAttribute('aria-expanded', !0),
          this._menu.classList.add(He),
          this._element.classList.add(He),
          l.trigger(this._element, Us, e);
      }
    }
    hide() {
      !le(this._element) && this._isShown() && this._completeHide({ relatedTarget: this._element });
    }
    dispose() {
    ...
    _completeHide(e) {
      if (!l.trigger(this._element, Vs, e).defaultPrevented) {
        if ('ontouchstart' in document.documentElement)
          for (const t of [].concat(...document.body.children)) l.off(t, 'mouseover', et);
        this._popper && this._popper.destroy(),
          this._menu.classList.remove(He),
          this._element.classList.remove(He),
          this._element.setAttribute('aria-expanded', 'false'),
          ne.removeDataAttribute(this._menu, 'popper'),
          l.trigger(this._element, Ks, e);
      }
    }
    _getConfig(e) {
      if (
    ...
    _getPlacement() {
      ...
      return e.classList.contains('dropup') ? (t ? Zs : Gs) : t ? eo : Js;
    }
    _detectNavbar() {
    ...
    static dataApiKeydownHandler(e) {
      const t = /input|textarea/i.test(e.target.tagName),
        n = 'Escape' === e.key,
        s = [qs, cn].includes(e.key);
      if ((!s && !n) || (t && !n)) return;
      e.preventDefault();
      const o = this.matches(be)
          ? this
          : f.prev(this, be)[0] ||
            f.next(this, be)[0] ||
            f.findOne(be, e.delegateTarget.parentNode),
        r = Q.getOrCreateInstance(o);
      if (s) return e.stopPropagation(), r.show(), void r._selectMenuItem(e);
      r._isShown() && (e.stopPropagation(), r.hide(), o.focus());
    }
  }
  l.on(document, dn, be, Q.dataApiKeydownHandler),
    l.on(document, dn, ut, Q.dataApiKeydownHandler),
    l.on(document, hn, Q.clearMenus),
    l.on(document, Ys, Q.clearMenus),
    l.on(document, hn, be, function (i) {
  ...
  class mn extends Re {
    ...
    dispose() {
      this._isAppended &&
        (l.off(this._element, pn), this._element.remove(), (this._isAppended = !1));
    }
    _getElement() {
      if (!this._element) {
  ...
  class _n extends Re {
    ...
    activate() {
      this._isActive ||
        ...
        l.off(document, ft),
        l.on(document, ao, e => this._handleFocusin(e)),
        l.on(document, lo, e => this._handleKeydown(e)),
        (this._isActive = !0));
    }
    deactivate() {
    ...
    _handleKeydown(e) {
      'Tab' === e.key && (this._lastTabNavDirection = e.shiftKey ? gn : 'forward');
    }
  }
  ...
  const q = '.bs.modal',
    ...
    mo = `resize${q}`,
    go = `click.dismiss${q}`,
    _o = `mousedown.dismiss${q}`,
    bo = `keydown.dismiss${q}`,
    vo = `click${q}.data-api`,
    An = 'modal-open',
    Gt = 'modal-static',
    yo = { backdrop: !0, focus: !0, keyboard: !0 },
    wo = { backdrop: '(boolean|string)', focus: 'boolean', keyboard: 'boolean' };
  class ve extends Y {
    constructor(e, t) {
      super(e, t),
    ...
    _initializeBackDrop() {
      return new mn({ isVisible: !!this._config.backdrop, isAnimated: this._isAnimated() });
    }
        ...
        this._queueCallback(
          () => {
            this._config.focus && this._focustrap.activate(),
              (this._isTransitioning = !1),
              l.trigger(this._element, po, { relatedTarget: e });
          },
          this._dialog,
          this._isAnimated()
        );
    ...
    _addEventListeners() {
      l.on(this._element, bo, e => {
        ...
        l.on(this._element, _o, e => {
          l.one(this._element, go, t => {
    ...
    _triggerBackdropTransition() {
      if (l.trigger(this._element, fo).defaultPrevented) return;
  ...
  l.on(document, vo, '[data-bs-toggle="modal"]', function (i) {
    const e = f.getElementFromSelector(this);
    ...
    t && ve.getInstance(t).hide(), ve.getOrCreateInstance(e).toggle(this);
  }),
    tt(ve),
    z(ve);
  const oe = '.bs.offcanvas',
    ...
    Oo = `resize${oe}`,
    xo = `click${oe}${Cn}`,
    ko = `keydown.dismiss${oe}`,
    Lo = { backdrop: !0, keyboard: !0, scroll: !1 },
    So = { backdrop: '(boolean|string)', keyboard: 'boolean', scroll: 'boolean' };
  class re extends Y {
    constructor(e, t) {
      super(e, t),
        (this._isShown = !1),
    ...
    show(e) {
      this._isShown ||
        l.trigger(this._element, Ao, { relatedTarget: e }).defaultPrevented ||
        ((this._isShown = !0),
        this._backdrop.show(),
        ...
        this._queueCallback(
          () => {
            (this._config.scroll && !this._config.backdrop) || this._focustrap.activate(),
              ...
              l.trigger(this._element, To, { relatedTarget: e });
          },
          this._element,
          !0
        ));
    ...
    _initializeBackDrop() {
      ...
      return new mn({
        ...
        clickCallback: e
          ? () => {
              'static' !== this._config.backdrop ? this.hide() : l.trigger(this._element, Sn);
            }
          : null,
      });
    }
    ...
    _addEventListeners() {
      l.on(this._element, ko, e => {
        'Escape' === e.key && (this._config.keyboard ? this.hide() : l.trigger(this._element, Sn));
      });
    }
    static jQueryInterface(e) {
      return this.each(function () {
  ...
  l.on(document, xo, '[data-bs-toggle="offcanvas"]', function (i) {
    const e = f.getElementFromSelector(this);
    if ((['A', 'AREA'].includes(this.tagName) && i.preventDefault(), le(this))) return;
    l.one(e, Dn, () => {
      Ce(this) && this.focus();
    });
    const t = f.findOne(Ln);
    t && t !== e && re.getInstance(t).hide(), re.getOrCreateInstance(e).toggle(this);
  }),
    l.on(window, Eo, () => {
    ...
    l.on(window, Oo, () => {
      for (const i of f.find('[aria-modal][class*=show][class*=offcanvas-]'))
        'fixed' !== getComputedStyle(i).position && re.getOrCreateInstance(i).hide();
    }),
    tt(re),
    z(re);
  const $n = {
    ...
    jo = { entry: '(string|element|function|null)', selector: '(string|element)' };
  class Mo extends Re {
    constructor(e) {
    ...
    _checkContent(e) {
      for (const [t, n] of Object.entries(e)) super._typeCheckConfig({ selector: t, entry: n }, jo);
    }
    _setContent(e, t, n) {
        ...
        ? (function (t, n, s) {
            ...
            for (const a of r) {
              ...
              const d = [].concat(...a.attributes),
                u = [].concat(n['*'] || [], n[c] || []);
              for (const h of d) Io(h, u) || a.removeAttribute(h.nodeName);
            }
  ...
  class ye extends Y {
    ...
    dispose() {
      clearTimeout(this._timeout),
        l.off(this._element.closest('.modal'), Nn, this._hideModalHandler),
    ...
    show() {
      ...
      const e = l.trigger(this._element, this.constructor.eventName('show')),
        t = (di(this._element) || this._element.ownerDocument.documentElement).contains(
          this._element
        );
      ...
      if (
        (this._element.ownerDocument.documentElement.contains(this.tip) ||
          (s.append(n), l.trigger(this._element, this.constructor.eventName('inserted'))),
        (this._popper = this._createPopper(n)),
        n.classList.add(mt),
        'ontouchstart' in document.documentElement)
      )
        for (const o of [].concat(...document.body.children)) l.on(o, 'mouseover', et);
      this._queueCallback(
        () => {
    ...
    hide() {
      if (
        this._isShown() &&
        !l.trigger(this._element, this.constructor.eventName('hide')).defaultPrevented
      ) {
        if (
          (this._getTipElement().classList.remove(mt), 'ontouchstart' in document.documentElement)
        )
          for (const e of [].concat(...document.body.children)) l.off(e, 'mouseover', et);
    ...
    _createTipElement(e) {
      ...
      if (!t) return null;
      t.classList.remove(Zt, mt), t.classList.add(`bs-${this.constructor.NAME}-auto`);
      const n = (s => {
        do {
      ...
      return t.setAttribute('id', n), this._isAnimated() && t.classList.add(Zt), t;
    }
    setContent(e) {
    ...
    _isAnimated() {
      return this._config.animation || (this.tip && this.tip.classList.contains(Zt));
    }
    _isShown() {
    ...
    _setListeners() {
      ...
      for (const t of e)
        if ('click' === t)
          ...
          const n = this.constructor.eventName(t === Ge ? 'mouseenter' : 'focusin'),
            s = this.constructor.eventName(t === Ge ? 'mouseleave' : 'focusout');
          l.on(this._element, n, this._config.selector, o => {
            const r = this._initializeOnDelegatedTarget(o);
            (r._activeTrigger['focusin' === o.type ? Jt : Ge] = !0), r._enter();
          }),
            l.on(this._element, s, this._config.selector, o => {
              const r = this._initializeOnDelegatedTarget(o);
              (r._activeTrigger['focusout' === o.type ? Jt : Ge] = r._element.contains(
                o.relatedTarget
              )),
                r._leave();
            });
      ...
      (this._hideModalHandler = () => {
        ...
        l.on(this._element.closest('.modal'), Nn, this._hideModalHandler);
    }
    _fixTitle() {
    ...
    _getConfig(e) {
      ...
      for (const n of Object.keys(t)) Fo.has(n) && delete t[n];
      return (
    ...
    _configAfterMerge(e) {
      return (
        (e.container = !1 === e.container ? document.body : ae(e.container)),
  ...
  const zo = {
    ...
    Ro = { ...ye.DefaultType, content: '(null|string|element|function)' };
  class gt extends ye {
    static get Default() {
      return zo;
    }
  ...
  const ei = '.bs.scrollspy',
    ...
    ti = '[href]',
    jn = '.nav-link',
    Ko = `${jn}, .nav-item > ${jn}, .list-group-item`,
    Xo = {
      offset: null,
  ...
  class Ze extends Y {
    ...
    _initializeTargetsAndObservables() {
      ...
      for (const t of e) {
        ...
        Ce(n) &&
          (this._targetLinks.set(decodeURI(t.hash), t), this._observableSections.set(t.hash, n));
      }
    }
    _process(e) {
      this._activeTarget !== e &&
        ...
        l.trigger(this._element, qo, { relatedTarget: e }));
    }
    _activateParents(e) {
      if (e.classList.contains('dropdown-item'))
        f.findOne('.dropdown-toggle', e.closest('.dropdown')).classList.add(We);
      else
        for (const t of f.parents(e, '.nav, .list-group'))
          for (const n of f.prev(t, Ko)) n.classList.add(We);
    }
    _clearActiveClass(e) {
      e.classList.remove(We);
      const t = f.find(`${ti}.${We}`, e);
      for (const n of t) n.classList.remove(We);
    }
    static jQueryInterface(e) {
      return this.each(function () {
  ...
  l.on(window, Vo, () => {
    for (const i of f.find('[data-bs-spy="scroll"]')) Ze.getOrCreateInstance(i);
  }),
    z(Ze);
  const we = '.bs.tab',
    Yo = `hide${we}`,
    ...
    sr = `.${Ee}[data-bs-toggle="tab"], .${Ee}[data-bs-toggle="pill"], .${Ee}[data-bs-toggle="list"]`;
  class Ae extends Y {
    constructor(e) {
      super(e),
        ...
        this._parent &&
          ...
          l.on(this._element, er, t => this._keydown(t)));
    }
    static get NAME() {
      return 'tab';
    }
    show() {
      ...
      const t = this._getActiveElem(),
        n = t ? l.trigger(t, Yo, { relatedTarget: e }) : null;
      l.trigger(e, Go, { relatedTarget: t }).defaultPrevented ||
          ...
          () => {
            'tab' === e.getAttribute('role')
              ? (e.removeAttribute('tabindex'),
                ...
                l.trigger(e, Zo, { relatedTarget: t }))
              : e.classList.add(ni);
          },
          e,
          ...
          () => {
            'tab' === e.getAttribute('role')
              ? (e.setAttribute('aria-selected', !1),
                ...
                l.trigger(e, Qo, { relatedTarget: t }))
    ...
    _keydown(e) {
      if (![ir, Mn, nr, Fn, ii, Hn].includes(e.key)) return;
      ...
      n && (n.focus({ preventScroll: !0 }), Ae.getOrCreateInstance(n).show());
    }
    _getChildren() {
    ...
    _toggleDropDown(e, t) {
      ...
      s(Bn, Ee), s('.dropdown-menu', ni), n.setAttribute('aria-expanded', t);
    }
  ...
  l.on(document, Jo, zn, function (i) {
    ['A', 'AREA'].includes(this.tagName) && i.preventDefault(),
      le(this) || Ae.getOrCreateInstance(this).show();
  }),
    l.on(window, tr, () => {
      for (const i of f.find(sr)) Ae.getOrCreateInstance(i);
    }),
    z(Ae);
  const de = '.bs.toast',
    or = `mouseover${de}`,
  ...
  class Je extends Y {
    ...
    show() {
      l.trigger(this._element, dr).defaultPrevented ||
        (this._clearTimeout(),
    ...
    _setListeners() {
      l.on(this._element, or, e => this._onInteraction(e, !0)),
        l.on(this._element, rr, e => this._onInteraction(e, !1)),
        l.on(this._element, ar, e => this._onInteraction(e, !0)),
        l.on(this._element, lr, e => this._onInteraction(e, !1));
    }
    _clearTimeout() {
